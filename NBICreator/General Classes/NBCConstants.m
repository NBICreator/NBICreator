...
NSString *const NBCMenuItemWorkflows = @"Workflow Queue";
...
NSString *const NBCSettingsImagrBackgroundImage = @"ImagrBackgroundImage";
NSString *const NBCSettingsImagrBackgroundImageKey = @"background_window";
