...
- (void)updateUISettingsFromDict:(NSDictionary *)settingsDict {
    ...
    [self setImagrBackgroundImage:settingsDict[NBCSettingsImagrBackgroundImage] ?: @"Auto"];
...
- (NSDictionary *)returnSettingsFromUI {
    ...
    settingsDict[NBCSettingsImagrBackgroundImage] = _imagrBackgroundImage ?: @"Auto";
...
- (void)updatePopUpButtonUSBDevices {
    ...
    NSMenuItem *titleMenuItem = [[NSMenuItem alloc] initWithTitle:@"USB Drives" action:nil keyEquivalent:@""];
