...
#pragma unused(notification)
    ...
    NSLog(@"currentTemplateName=%@", currentTemplateName);
    NSURL *currentTemplateURL = [_settingsViewController templatesDict][currentTemplateName];
    NSLog(@"currentTemplateURL=%@", currentTemplateURL);
