...
- (void)dealloc {
    if (_disk) CFRelease(_disk);
    if (_diskDescription) CFRelease(_diskDescription);
    parent = nil;
}
...
- (void)mountAtPath:(NSString *)path withArguments:(NSArray *)args
{
    ...
    DADiskMountWithArguments((DADiskRef) _disk, (__bridge CFURLRef) url, kDADiskMountOptionDefault,
                             DiskMountCallback, (__bridge void *)(self), (CFStringRef *)argv);
