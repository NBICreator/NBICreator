...
void DiskAppearedCallback(DADiskRef diskRef, void *context) {
    if (context != (__bridge void *)([NBCDisk class]))
        return;
...
#pragma unused(diskRef)
    ...
    if (dissenter) {
        ...
        info = @{ DAStatusErrorKey : @(status), NSLocalizedFailureReasonErrorKey : statusString, NSLocalizedRecoverySuggestionErrorKey : statusString };
    }
