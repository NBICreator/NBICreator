...
@implementation NBCCasperDropViewController
...
- (id)init {
    self = [super initWithNibName:@"NBCCasperDropViewController" bundle:nil];
    if (self != nil) {
...
- (void)viewDidLoad {
    ...
    [nc addObserver:self selector:@selector(verifyDroppedSource:) name:NBCNotificationCasperVerifyDroppedSource object:nil];
...
- (void)updateSourceInfo:(NBCSource *)source {
    ...
    NSNotificationCenter *nc = [NSNotificationCenter defaultCenter];
    [nc postNotificationName:NBCNotificationCasperUpdateSource object:self userInfo:userInfo];
...
- (void)restoreDropView {
    ...
    // ------------------------------------------------------
    NSNotificationCenter *nc = [NSNotificationCenter defaultCenter];
    [nc postNotificationName:NBCNotificationCasperRemovedSource object:self userInfo:nil];
...
- (void)verifySource:(NSURL *)sourceURL {
    ...
    dispatch_async(taskQueue, ^{
        ...
        if ( verified ) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                [self restoreDropView];
                [NBCAlerts showAlertUnrecognizedSourceForWorkflow:kWorkflowTypeCasper errorMessage:errorMessage];
            });
        }
    });
} // verifySource
...
#pragma mark -
#pragma mark NBCCasperDropView
////////////////////////////////////////////////////////////////////////////////

@implementation NBCCasperDropView
...
- (BOOL)performDragOperation:(id <NSDraggingInfo>)sender {
    ...
    if ( draggedFileURL ) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NBCNotificationCasperVerifyDroppedSource
                                                            object:self
...
////////////////////////////////////////////////////////////////////////////////
#pragma mark NBCCasperDropViewBox
////////////////////////////////////////////////////////////////////////////////

@implementation NBCCasperDropViewBox
...
- (NSDragOperation)draggingEntered:(id <NSDraggingInfo> )sender {
    ...
    NBCCasperDropView *dropView = [[NBCCasperDropView alloc] init];
...
////////////////////////////////////////////////////////////////////////////////
#pragma mark NBCCasperDropViewImageView
////////////////////////////////////////////////////////////////////////////////

@implementation NBCCasperDropViewImageView
