...
@interface NBCCasperDropViewController : NSViewController
...
@interface NBCCasperDropView : NSView <NSDraggingDestination> @end
@interface NBCCasperDropViewBox : NSBox <NSDraggingDestination> @end
@interface NBCCasperDropViewImageView : NSImageView <NSDraggingDestination> @end
