...
@implementation NBCCasperWorkflowNBI
...
- (void)runWorkflow:(NBCWorkflowItem *)workflowItem {
    DDLogInfo(@"Starting workflow Casper NBI...");
...
- (void)createNBIFilesNBICreator:(NBCWorkflowItem *)workflowItem baseSystemTemporaryURL:(NSURL *)baseSystemTemporaryURL {
    ...
    NSFileManager *fm = [NSFileManager defaultManager];
    NBCCasperWorkflowModifyNBI *modifyNBI = [[NBCCasperWorkflowModifyNBI alloc] init];
