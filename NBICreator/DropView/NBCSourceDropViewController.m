...
#pragma unused(object, change, context)
    ...
    if ( [keyPath isEqualToString:@"nbiCreationTool"] ) {
        ...
        if ( [nbiType length] != 0 && [_nbiType length] == 0 ) {
            ...
            [self setSourceTypes:[NBCDropViewController sourceTypesForNbiType:nbiType] ?: @[]];
            [self updateViewForSourceTypes];
...
#pragma unused(object, change, context)
    if ( [keyPath isEqualToString:@"nbiCreationTool"] ) {
        ...
        [self setSourceTypes:[NBCDropViewController sourceTypesForNbiType:change[@"new"]] ?: @[]];
    }
