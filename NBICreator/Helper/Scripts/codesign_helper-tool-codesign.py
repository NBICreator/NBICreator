...
// NOTE: In NBICreator the path is
// ${PROJECT_DIR}/Supporting Files/Codesign/codesign.py
'''
...
HELPER_INFO = 'Helper/Supporting Files/NBICreatorHelper-Info.plist'
HELPER_LAUNCHD = 'Helper/Supporting Files/NBICreatorHelper-Launchd.plist'
...
HELPER_NAME_OVERRIDE = 'com.github.NBICreatorHelper'
...
def edit_app_info_plist(cert_id, bundle_id):
    ...
    try:
        ...
        if HELPER_NAME_OVERRIDE:
            ...
            helper_id = ''.join([bundle_id, '.helper'])
...
def edit_helper_info_plist(cert_id, project_path, bundle_id, app_name):
    ...
    try:
        ...
        print "There is no Info.plist for the helper app. Something's really wrong."
        exit(1)
...
def main():
    ...
    helper_id = edit_app_info_plist(cs_ident, bundle_id)
